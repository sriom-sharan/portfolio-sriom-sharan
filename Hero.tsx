          ...
          <div className="flex flex-col  md:flex-row gap-4">
            <div className="flex flex-col  justify-center md:justify-end ">
              ...
              <div className="md:flex hidden w-full md:flex-col justify-start lg:flex-row gap-2  md:gap-3 lg:gap-4 items-start">
                ...
                <a href={`${basePath}/Resume.pdf`} download={"optional-value"}>
            ...
            <div className="flex-col gap-4 flex justify-center items-center">
              <div className="border-b-2 aspect-square p-2 flex justify-end rounded-full border-purple">
                <Image
                  width={400}
                  height={400}
                  alt="profile picture"
                  className="bg-gray-200/5 md:w-[550px]  lg:w-[650px]   shadow-sm outline-x-purple w-72 brightness-90 contrast-100 saturate-100  rounded-full"
                  src={`${basePath}/professional_no_BG.png`}
                />
              </div>
              ...
              <div className="flex md:hidden flex-col gap-4 w-full items-center">
                ...
                <a href={`${basePath}/Resume.pdf`} className="w-full" download={"optional-value"}>
